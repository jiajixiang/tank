...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			List<DATATYPE_BASE> pAvatar_OnFire_args = new List<DATATYPE_BASE>();
			pAvatar_OnFire_args.Add(EntityDef.id2datatypes[8]);

			Method pAvatar_OnFire = new Method();
			pAvatar_OnFire.name = "OnFire";
			pAvatar_OnFire.methodUtype = 8;
			pAvatar_OnFire.aliasID = 1;
			pAvatar_OnFire.args = pAvatar_OnFire_args;

			pAvatarModule.methods["OnFire"] = pAvatar_OnFire; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_OnFire.aliasID] = pAvatar_OnFire;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(OnFire / 8).");
			...
			pAvatar_onAddSkill.methodUtype = 13;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onAddSkill / 13).");
			...
			pAvatar_onRemoveSkill.methodUtype = 14;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onRemoveSkill / 14).");
			...
			List<DATATYPE_BASE> pAvatar_Fire_args = new List<DATATYPE_BASE>();
			pAvatar_Fire_args.Add(EntityDef.id2datatypes[8]);

			Method pAvatar_Fire = new Method();
			pAvatar_Fire.name = "Fire";
			pAvatar_Fire.methodUtype = 5;
			pAvatar_Fire.aliasID = -1;
			pAvatar_Fire.args = pAvatar_Fire_args;

			pAvatarModule.methods["Fire"] = pAvatar_Fire; 
			pAvatarModule.cell_methods["Fire"] = pAvatar_Fire;

			pAvatarModule.idcell_methods[pAvatar_Fire.methodUtype] = pAvatar_Fire;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(Fire / 5).");
			...
			pAvatar_requestPull.methodUtype = 12;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(requestPull / 12).");

			List<DATATYPE_BASE> pAvatar_takeDamage_args = new List<DATATYPE_BASE>();
			pAvatar_takeDamage_args.Add(EntityDef.id2datatypes[8]);
			pAvatar_takeDamage_args.Add(EntityDef.id2datatypes[8]);

			Method pAvatar_takeDamage = new Method();
			pAvatar_takeDamage.name = "takeDamage";
			pAvatar_takeDamage.methodUtype = 6;
			pAvatar_takeDamage.aliasID = -1;
			pAvatar_takeDamage.args = pAvatar_takeDamage_args;

			pAvatarModule.methods["takeDamage"] = pAvatar_takeDamage; 
			pAvatarModule.cell_methods["takeDamage"] = pAvatar_takeDamage;

			pAvatarModule.idcell_methods[pAvatar_takeDamage.methodUtype] = pAvatar_takeDamage;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(takeDamage / 6).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(helloCB / 29).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(say / 28).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(hello / 27).");
			...
			pTestNoBase_helloCB.methodUtype = 31;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(helloCB / 31).");
			...
			pTestNoBase_hello.methodUtype = 30;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(hello / 30).");
			...
			pMonster_recvDamage.methodUtype = 35;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(recvDamage / 35).");
